...
export const REMOVE_PLAYLIST_FROM_PLAYING = "REMOVE_PLAYLIST_FROM_PLAYING"; // deprecated
export const ADD_PLAYLISTS_TO_LIST_TO_PLAY = "ADD_PLAYLISTS_TO_LIST_TO_PLAY";
export const REMOVE_PLAYLISTS_FROM_LIST_TO_PLAY =
...
export const ADD_VIDEOS_TO_LIST_TO_PLAY = "ADD_VIDEOS_TO_LIST_TO_PLAY";
export const REMOVE_VIDEOS_FROM_LIST_TO_PLAY =
...
export const UPDATE_LIST_TO_PLAY = "UPDATE_LIST_TO_PLAY";
export const CLEAR_LIST_TO_PLAY = "CLEAR_LIST_TO_PLAY";
export const SHUFFLE_LIST_TO_PLAY = "SHUFFLE_LIST_TO_PLAY";
