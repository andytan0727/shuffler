// remove this if react-split types are officially supported
declare module "react-split" {
  export interface SplitProps
    extends import("react").HTMLProps<HTMLDivElement> {
  ...
  const Split: (props: SplitProps) => import("react").ReactElement;
