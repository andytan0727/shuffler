...
import { YTPlaylistState, YTPlaylistAction } from "./types";
...
export const ytplaylist: Reducer<YTPlaylistState, YTPlaylistAction> = produce(
  (draft: Draft<YTPlaylistState>, action: YTPlaylistAction) => {
    switch (action.type) {
      // NOTE: TESTED
