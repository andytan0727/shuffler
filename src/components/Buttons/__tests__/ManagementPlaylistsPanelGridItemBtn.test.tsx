...
const renderManagementPlaylistsPanelGridItemBtn = partial(
  renderWithRedux,
  <ManagementPlaylistsPanelGridItemBtn playlistId={playlistId} />
);

describe("testing ManagementPlaylistsPanelGridItemBtn component", () => {
  ...
  test("should render without crashing", () => {
    const { container } = renderManagementPlaylistsPanelGridItemBtn();

    expect(container.firstChild).toBeInTheDocument();
  });

  test("should render play button and handle play function correctly", () => {
    const { getByTitle } = renderManagementPlaylistsPanelGridItemBtn();
  ...
  test("should render RemovePlaylistFromPlayingBtn when playlistInPlaying is true", () => {
    ...
    } = renderManagementPlaylistsPanelGridItemBtn(storeWithPlaylists);
...
describe("testing ManagementPlaylistsPanelGridItemBtn clicks", () => {
  let initialState: DeepPartial<AppState>;
  let storeWithPlaylists: ReturnType<typeof generateMockStore>;
  ...
  test("should handle delete button clicks correctly", () => {
    const { getByTitle, unmount } = renderManagementPlaylistsPanelGridItemBtn(
      storeWithPlaylists
    );
